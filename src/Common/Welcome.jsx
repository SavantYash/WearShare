        ...
        <>
            ...
            <div className="after d-flex justify-content-evenly align-items-center bg-dark p-5">
                ...
                <div className=" inner">
                    ...
                    <p className="text-white text-rounds mt-2">10000+ Donation</p>
                </div>
            </div>
            <div className="about" id="about">
                ...
                <p className="about-text fs-5">
                    E-Cloth Donation is a platform that bridges the gap between donors and
            ...
            <div className="footer-text">✦ All rights reserved © 2025 Wear Share ✦</div>
        </>
    )
}
